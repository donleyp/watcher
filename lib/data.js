...
class Data {
    ...
    async init(dir) {
        ...
        try {
            ...
            if (err.code == 'ENOENT') {
                ...
                console.log('error initializing data directory.')
                throw err;
            }
        }
    }
    ...
    async create(dir, file, data) {
        try {
            ...
            console.log('error creating datafile', err);
            throw new Exception(Exception.codes.IO_ERROR, 'error saving data.');
        }
    }
    ...
    async exists(dir, file) {
        try {
            ...
            if (err.code == 'ENOENT') {
                ...
                throw new Exception(Exceptions.codes.IO_ERROR, 'error testing for existence of datafile.');
            }
        }
    }
    ...
    handleIoError(err) {
        ...
        throw new Exception(exCode, 'error reading datafile.');
    }
}
